...
function getCharacters(){
    const char_url = `http://gateway.marvel.com/v1/public/characters?&ts=1&apikey=4906069c197e411cb19caa044c992842&hash=409eb1707112052380109d1472a0dc44&limit=100`
    getCharApi(char_url)
}
getCharacters()
...
searchbar.onkeyup = function(event){
    ...
    if(userData!=''){
        ...
        var api_url = `http://gateway.marvel.com/v1/public/characters?nameStartsWith=${userData}&ts=1&apikey=4906069c197e411cb19caa044c992842&hash=409eb1707112052380109d1472a0dc44`
        getApi(api_url)
    }
